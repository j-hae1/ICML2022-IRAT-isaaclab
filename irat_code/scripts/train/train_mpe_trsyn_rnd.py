...
def main(args):
    ...
    if all_args.algorithm_name == "rmappotrsynrnd" or all_args.algorithm_name == "rmappo":
        assert (all_args.use_recurrent_policy or all_args.use_naive_recurrent_policy), ("check recurrent policy!")
    elif all_args.algorithm_name == "mappotrsynrnd" or all_args.algorithm_name == "mappo":
